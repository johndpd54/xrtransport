...
static void serialize(const T* x, std::ostream& out) {
    static_assert(
        std::is_same<T, XrBool32>::value || std::is_same<T, XrFlags64>::value || std::is_same<T, XrTime>::value || std::is_same<T, XrDuration>::value || std::is_same<T, XrVersion>::value || std::is_same<T, XrSpaceUserIdFB>::value || std::is_same<T, XrPath>::value || std::is_same<T, XrSystemId>::value || std::is_same<T, XrControllerModelKeyMSFT>::value || std::is_same<T, XrAsyncRequestIdFB>::value || std::is_same<T, XrRenderModelKeyFB>::value || std::is_same<T, XrMarkerML>::value || std::is_same<T, void>::value || std::is_same<T, char>::value || std::is_same<T, wchar_t>::value || std::is_same<T, float>::value || std::is_same<T, int8_t>::value || std::is_same<T, uint8_t>::value || std::is_same<T, int16_t>::value || std::is_same<T, uint16_t>::value || std::is_same<T, int32_t>::value || std::is_same<T, uint32_t>::value || std::is_same<T, int64_t>::value || std::is_same<T, uint64_t>::value || std::is_same<T, size_t>::value || std::is_same<T, uintptr_t>::value || std::is_same<T, double>::value || std::is_same<T, XrInstanceCreateFlags>::value || std::is_same<T, XrSessionCreateFlags>::value || std::is_same<T, XrSwapchainCreateFlags>::value || std::is_same<T, XrSwapchainUsageFlags>::value || std::is_same<T, XrViewStateFlags>::value || std::is_same<T, XrCompositionLayerFlags>::value || std::is_same<T, XrSpaceLocationFlags>::value || std::is_same<T, XrSpaceVelocityFlags>::value || std::is_same<T, XrInputSourceLocalizedNameFlags>::value || std::is_same<T, XrVulkanInstanceCreateFlagsKHR>::value || std::is_same<T, XrVulkanDeviceCreateFlagsKHR>::value || std::is_same<T, XrDebugUtilsMessageSeverityFlagsEXT>::value || std::is_same<T, XrDebugUtilsMessageTypeFlagsEXT>::value || std::is_same<T, XrFrameSynthesisInfoFlagsEXT>::value || std::is_same<T, XrOverlayMainSessionFlagsEXTX>::value || std::is_same<T, XrOverlaySessionCreateFlagsEXTX>::value || std::is_same<T, XrAndroidSurfaceSwapchainFlagsFB>::value || std::is_same<T, XrCompositionLayerImageLayoutFlagsFB>::value || std::is_same<T, XrCompositionLayerSecureContentFlagsFB>::value || std::is_same<T, XrSwapchainCreateFoveationFlagsFB>::value || std::is_same<T, XrSwapchainStateFoveationFlagsFB>::value || std::is_same<T, XrFoveationEyeTrackedProfileCreateFlagsMETA>::value || std::is_same<T, XrFoveationEyeTrackedStateFlagsMETA>::value || std::is_same<T, XrTriangleMeshFlagsFB>::value || std::is_same<T, XrPassthroughFlagsFB>::value || std::is_same<T, XrPassthroughStateChangedFlagsFB>::value || std::is_same<T, XrPassthroughCapabilityFlagsFB>::value || std::is_same<T, XrSemanticLabelsSupportFlagsFB>::value || std::is_same<T, XrHandTrackingAimFlagsFB>::value || std::is_same<T, XrKeyboardTrackingFlagsFB>::value || std::is_same<T, XrKeyboardTrackingQueryFlagsFB>::value || std::is_same<T, XrCompositionLayerSpaceWarpInfoFlagsFB>::value || std::is_same<T, XrRenderModelFlagsFB>::value || std::is_same<T, XrDigitalLensControlFlagsALMALENCE>::value || std::is_same<T, XrCompositionLayerSettingsFlagsFB>::value || std::is_same<T, XrExternalCameraStatusFlagsOCULUS>::value || std::is_same<T, XrPerformanceMetricsCounterFlagsMETA>::value || std::is_same<T, XrPassthroughPreferenceFlagsMETA>::value || std::is_same<T, XrFoveationDynamicFlagsHTC>::value || std::is_same<T, XrFrameEndInfoFlagsML>::value || std::is_same<T, XrGlobalDimmerFrameEndInfoFlagsML>::value || std::is_same<T, XrPlaneDetectorFlagsEXT>::value || std::is_same<T, XrPlaneDetectionCapabilityFlagsEXT>::value || std::is_same<T, XrVirtualKeyboardInputStateFlagsMETA>::value || std::is_same<T, XrLocalizationMapErrorFlagsML>::value || std::is_same<T, XrEnvironmentDepthProviderCreateFlagsMETA>::value || std::is_same<T, XrEnvironmentDepthSwapchainCreateFlagsMETA>::value || std::is_same<T, XrWorldMeshDetectorFlagsML>::value || std::is_same<T, XrFacialExpressionBlendShapePropertiesFlagsML>::value || std::is_same<T, XrSpatialMeshConfigFlagsBD>::value || std::is_same<T, XrInstance>::value || std::is_same<T, XrSession>::value || std::is_same<T, XrActionSet>::value || std::is_same<T, XrAction>::value || std::is_same<T, XrSwapchain>::value || std::is_same<T, XrSpace>::value || std::is_same<T, XrDebugUtilsMessengerEXT>::value || std::is_same<T, XrSpatialAnchorMSFT>::value || std::is_same<T, XrHandTrackerEXT>::value || std::is_same<T, XrFoveationProfileFB>::value || std::is_same<T, XrTriangleMeshFB>::value || std::is_same<T, XrPassthroughFB>::value || std::is_same<T, XrPassthroughLayerFB>::value || std::is_same<T, XrGeometryInstanceFB>::value || std::is_same<T, XrFacialTrackerHTC>::value || std::is_same<T, XrPassthroughHTC>::value || std::is_same<T, XrFaceTrackerFB>::value || std::is_same<T, XrFaceTracker2FB>::value || std::is_same<T, XrBodyTrackerFB>::value || std::is_same<T, XrEyeTrackerFB>::value || std::is_same<T, XrSpaceUserFB>::value || std::is_same<T, XrPassthroughColorLutMETA>::value || std::is_same<T, XrPlaneDetectorEXT>::value || std::is_same<T, XrVirtualKeyboardMETA>::value || std::is_same<T, XrSpatialAnchorsStorageML>::value || std::is_same<T, XrExportedLocalizationMapML>::value || std::is_same<T, XrMarkerDetectorML>::value || std::is_same<T, XrFacialExpressionClientML>::value || std::is_same<T, XrEnvironmentDepthProviderMETA>::value || std::is_same<T, XrEnvironmentDepthSwapchainMETA>::value || std::is_same<T, XrBodyTrackerHTC>::value || std::is_same<T, XrWorldMeshDetectorML>::value || std::is_same<T, XrBodyTrackerBD>::value || std::is_same<T, XrSpatialEntityIdBD>::value || std::is_same<T, XrSenseDataProviderBD>::value || std::is_same<T, XrSenseDataSnapshotBD>::value || std::is_same<T, XrAnchorBD>::value || std::is_same<T, XrFutureEXT>::value || std::is_same<T, XrLoaderInterfaceStructs>::value || std::is_same<T, XrStructureType>::value || std::is_same<T, XrResult>::value || std::is_same<T, XrObjectType>::value || std::is_same<T, XrInstanceCreateFlagBits>::value || std::is_same<T, XrSessionCreateFlagBits>::value || std::is_same<T, XrSwapchainCreateFlagBits>::value || std::is_same<T, XrSwapchainUsageFlagBits>::value || std::is_same<T, XrViewStateFlagBits>::value || std::is_same<T, XrCompositionLayerFlagBits>::value || std::is_same<T, XrSpaceLocationFlagBits>::value || std::is_same<T, XrSpaceVelocityFlagBits>::value || std::is_same<T, XrInputSourceLocalizedNameFlagBits>::value || std::is_same<T, XrAndroidThreadTypeKHR>::value || std::is_same<T, XrEyeVisibility>::value || std::is_same<T, XrActionType>::value || std::is_same<T, XrReferenceSpaceType>::value || std::is_same<T, XrFormFactor>::value || std::is_same<T, XrViewConfigurationType>::value || std::is_same<T, XrEnvironmentBlendMode>::value || std::is_same<T, XrSessionState>::value || std::is_same<T, XrPerfSettingsDomainEXT>::value || std::is_same<T, XrPerfSettingsSubDomainEXT>::value || std::is_same<T, XrPerfSettingsLevelEXT>::value || std::is_same<T, XrPerfSettingsNotificationLevelEXT>::value || std::is_same<T, XrVulkanInstanceCreateFlagBitsKHR>::value || std::is_same<T, XrVulkanDeviceCreateFlagBitsKHR>::value || std::is_same<T, XrDebugUtilsMessageSeverityFlagBitsEXT>::value || std::is_same<T, XrDebugUtilsMessageTypeFlagBitsEXT>::value || std::is_same<T, XrFrameSynthesisInfoFlagBitsEXT>::value || std::is_same<T, XrOverlayMainSessionFlagBitsEXTX>::value || std::is_same<T, XrOverlaySessionCreateFlagBitsEXTX>::value || std::is_same<T, XrVisibilityMaskTypeKHR>::value || std::is_same<T, XrSpatialGraphNodeTypeMSFT>::value || std::is_same<T, XrAndroidSurfaceSwapchainFlagBitsFB>::value || std::is_same<T, XrCompositionLayerImageLayoutFlagBitsFB>::value || std::is_same<T, XrBlendFactorFB>::value || std::is_same<T, XrCompositionLayerSecureContentFlagBitsFB>::value || std::is_same<T, XrSpaceComponentTypeFB>::value || std::is_same<T, XrSwapchainCreateFoveationFlagBitsFB>::value || std::is_same<T, XrSwapchainStateFoveationFlagBitsFB>::value || std::is_same<T, XrFoveationEyeTrackedProfileCreateFlagBitsMETA>::value || std::is_same<T, XrFoveationEyeTrackedStateFlagBitsMETA>::value || std::is_same<T, XrTriangleMeshFlagBitsFB>::value || std::is_same<T, XrWindingOrderFB>::value || std::is_same<T, XrPassthroughFlagBitsFB>::value || std::is_same<T, XrPassthroughLayerPurposeFB>::value || std::is_same<T, XrPassthroughStateChangedFlagBitsFB>::value || std::is_same<T, XrPassthroughCapabilityFlagBitsFB>::value || std::is_same<T, XrCompositionLayerSpaceWarpInfoFlagBitsFB>::value || std::is_same<T, XrRenderModelFlagBitsFB>::value || std::is_same<T, XrSpaceQueryActionFB>::value || std::is_same<T, XrSpaceStorageLocationFB>::value || std::is_same<T, XrSpacePersistenceModeFB>::value || std::is_same<T, XrSemanticLabelsSupportFlagBitsFB>::value || std::is_same<T, XrHandTrackingAimFlagBitsFB>::value || std::is_same<T, XrKeyboardTrackingFlagBitsFB>::value || std::is_same<T, XrKeyboardTrackingQueryFlagBitsFB>::value || std::is_same<T, XrDigitalLensControlFlagBitsALMALENCE>::value || std::is_same<T, XrCompositionLayerSettingsFlagBitsFB>::value || std::is_same<T, XrExternalCameraStatusFlagBitsOCULUS>::value || std::is_same<T, XrExternalCameraAttachedToDeviceOCULUS>::value || std::is_same<T, XrPassthroughColorLutChannelsMETA>::value || std::is_same<T, XrPerformanceMetricsCounterFlagBitsMETA>::value || std::is_same<T, XrPerformanceMetricsCounterUnitMETA>::value || std::is_same<T, XrPassthroughPreferenceFlagBitsMETA>::value || std::is_same<T, XrFacialTrackingTypeHTC>::value || std::is_same<T, XrEyeExpressionHTC>::value || std::is_same<T, XrLipExpressionHTC>::value || std::is_same<T, XrPassthroughFormHTC>::value || std::is_same<T, XrFoveationModeHTC>::value || std::is_same<T, XrFoveationDynamicFlagBitsHTC>::value || std::is_same<T, XrFoveationLevelHTC>::value || std::is_same<T, XrLocalDimmingModeMETA>::value || std::is_same<T, XrFaceExpressionFB>::value || std::is_same<T, XrFaceExpressionSetFB>::value || std::is_same<T, XrFaceConfidenceFB>::value || std::is_same<T, XrFaceExpression2FB>::value || std::is_same<T, XrFaceExpressionSet2FB>::value || std::is_same<T, XrFaceTrackingDataSource2FB>::value || std::is_same<T, XrFaceConfidence2FB>::value || std::is_same<T, XrBodyJointFB>::value || std::is_same<T, XrBodyJointSetFB>::value || std::is_same<T, XrFullBodyJointMETA>::value || std::is_same<T, XrFrameEndInfoFlagBitsML>::value || std::is_same<T, XrEyePositionFB>::value || std::is_same<T, XrGlobalDimmerFrameEndInfoFlagBitsML>::value || std::is_same<T, XrTrackingOptimizationSettingsDomainQCOM>::value || std::is_same<T, XrTrackingOptimizationSettingsHintQCOM>::value || std::is_same<T, XrForceFeedbackCurlLocationMNDX>::value || std::is_same<T, XrPlaneDetectionStateEXT>::value || std::is_same<T, XrPlaneDetectorOrientationEXT>::value || std::is_same<T, XrPlaneDetectorSemanticTypeEXT>::value || std::is_same<T, XrPlaneDetectorFlagBitsEXT>::value || std::is_same<T, XrPlaneDetectionCapabilityFlagBitsEXT>::value || std::is_same<T, XrVirtualKeyboardLocationTypeMETA>::value || std::is_same<T, XrVirtualKeyboardInputSourceMETA>::value || std::is_same<T, XrVirtualKeyboardInputStateFlagBitsMETA>::value || std::is_same<T, XrHeadsetFitStatusML>::value || std::is_same<T, XrEyeCalibrationStatusML>::value || std::is_same<T, XrLocalizationMapStateML>::value || std::is_same<T, XrLocalizationMapTypeML>::value || std::is_same<T, XrLocalizationMapConfidenceML>::value || std::is_same<T, XrLocalizationMapErrorFlagBitsML>::value || std::is_same<T, XrMarkerDetectorProfileML>::value || std::is_same<T, XrMarkerTypeML>::value || std::is_same<T, XrMarkerArucoDictML>::value || std::is_same<T, XrMarkerAprilTagDictML>::value || std::is_same<T, XrMarkerDetectorFpsML>::value || std::is_same<T, XrMarkerDetectorResolutionML>::value || std::is_same<T, XrMarkerDetectorCameraML>::value || std::is_same<T, XrMarkerDetectorCornerRefineMethodML>::value || std::is_same<T, XrMarkerDetectorFullAnalysisIntervalML>::value || std::is_same<T, XrMarkerDetectorStatusML>::value || std::is_same<T, XrFacialBlendShapeML>::value || std::is_same<T, XrFacialExpressionBlendShapePropertiesFlagBitsML>::value || std::is_same<T, XrFutureStateEXT>::value || std::is_same<T, XrEnvironmentDepthProviderCreateFlagBitsMETA>::value || std::is_same<T, XrEnvironmentDepthSwapchainCreateFlagBitsMETA>::value || std::is_same<T, XrBodyJointHTC>::value || std::is_same<T, XrBodyJointSetHTC>::value || std::is_same<T, XrBodyJointConfidenceHTC>::value || std::is_same<T, XrSpatialAnchorConfidenceML>::value || std::is_same<T, XrWorldMeshBlockStatusML>::value || std::is_same<T, XrWorldMeshDetectorFlagBitsML>::value || std::is_same<T, XrWorldMeshDetectorLodML>::value || std::is_same<T, XrWorldMeshBlockResultML>::value || std::is_same<T, XrBodyJointBD>::value || std::is_same<T, XrBodyJointSetBD>::value || std::is_same<T, XrSenseDataProviderTypeBD>::value || std::is_same<T, XrSemanticLabelBD>::value || std::is_same<T, XrSpatialEntityComponentTypeBD>::value || std::is_same<T, XrSenseDataProviderStateBD>::value || std::is_same<T, XrPersistenceLocationBD>::value || std::is_same<T, XrSpatialMeshLodBD>::value || std::is_same<T, XrSpatialMeshConfigFlagBitsBD>::value || std::is_same<T, XrSpatialGraphNodeBindingMSFT>::value || std::is_same<T, XrHandEXT>::value || std::is_same<T, XrHandJointEXT>::value || std::is_same<T, XrHandJointSetEXT>::value || std::is_same<T, XrHandJointsMotionRangeEXT>::value || std::is_same<T, XrHandTrackingDataSourceEXT>::value || std::is_same<T, XrHandPoseTypeMSFT>::value || std::is_same<T, XrSceneObserverMSFT>::value || std::is_same<T, XrSceneMSFT>::value || std::is_same<T, XrSceneObjectTypeMSFT>::value || std::is_same<T, XrScenePlaneAlignmentTypeMSFT>::value || std::is_same<T, XrSceneComputeStateMSFT>::value || std::is_same<T, XrSceneComputeFeatureMSFT>::value || std::is_same<T, XrSceneComputeConsistencyMSFT>::value || std::is_same<T, XrSceneComponentTypeMSFT>::value || std::is_same<T, XrMeshComputeLodMSFT>::value || std::is_same<T, XrSceneMarkerTypeMSFT>::value || std::is_same<T, XrSceneMarkerQRCodeSymbolTypeMSFT>::value || std::is_same<T, XrColorSpaceFB>::value || std::is_same<T, XrFoveationLevelFB>::value || std::is_same<T, XrFoveationDynamicFB>::value || std::is_same<T, XrReprojectionModeMSFT>::value || std::is_same<T, XrSpatialAnchorStoreConnectionMSFT>::value || std::is_same<T, XrHandForearmJointULTRALEAP>::value || std::is_same<T, XrCompareOpFB>::value,
